window.onload = function () {
  if (localStorage.getItem("dbUrl")) {
    document.querySelector("#db-url").value = localStorage.getItem("dbUrl");
    document.querySelector("#db-port").value = localStorage.getItem("dbPort");
    document.querySelector("#db-database").value =
      localStorage.getItem("dbDatabase");
    document.querySelector("#db-user").value =
      localStorage.getItem("dbUsername");
    document.querySelector("#db-password").value =
      localStorage.getItem("dbPassword");

    document.querySelector("#workspace").value = localStorage.getItem(
      "workspace",
      workspace
    );
    document.querySelector("#package").value = localStorage.getItem(
      "package",
      package
    );
  }
  ...
  connectBtn.addEventListener("click", async function () {
    ...
    if (dbUrl.trim() === "") {
      ...
      if (tableList.tables && confirm("접속 정보를 저장할까요?")) {
        ...
        localStorage.setItem("dbDatabase", dbDatabase);
