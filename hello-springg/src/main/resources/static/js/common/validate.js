    ...
    $("label.require + div")
        ...
        $("label.password + div")
            ...
            .on("keyup", function(){
                ...
                var passworConfirm = $("#password-confirm");
                
                console.log(password);
                console.log(passworConfirm);
                
                if(password.val() !== passworConfirm.val()){
                    
                     var errorLength = password.closest("div").children(".validate-password").length;
                     errorLength += passworConfirm.closest("div").children(".validate-password").length;
                         
                     if(errorLength === 0){
                         password.after($("<span class='validate-error validate-password'>비밀번호가 일치하지 않습니다.</span>"));
                         passworConfirm.after($("<span class='validate-error validate-password'>비밀번호가 일치하지 않습니다.</span>"));
                     }
                     else{
                        password.closest("div").children(".validate-password").remove(); 
                        passworConfirm.closest("div").children(".validate-password").remove(); 
                     }   
                }*/
                /*
                console.log($(this).val());
